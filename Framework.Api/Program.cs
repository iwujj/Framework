...
//添加数据库上下文
builder.Services.AddReadWriteDbContext<FrameworkContext>(optionsBuilderWrite =>
{
    optionsBuilderWrite.UseSqlServer(AppSettings.WriteConnectionString);
}, optionsBuilderRead =>
{
    optionsBuilderRead.UseSqlServer(AppSettings.ReadConnectionString);
});
builder.Services.AddTransient<FrameworkDBContextFactory<FrameworkContext>>();
//兼容同步请求
...
app.UseEndpoints(endpoints =>
{
    ...
    {
        var dbg = new DataBaseDictionaryGenerator(AppSettings.WriteConnectionString);
